...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<activejob>.freeze, [">= 7.1"])
    s.add_dependency(%q<railties>.freeze, [">= 7.1"])
    s.add_dependency(%q<concurrent-ruby>.freeze, [">= 1.3.1"])
    s.add_dependency(%q<fugit>.freeze, ["~> 1.11.0"])
    s.add_dependency(%q<thor>.freeze, [">= 1.3.1"])
    s.add_dependency(%q<appraisal>.freeze, [">= 0"])
    s.add_dependency(%q<debug>.freeze, ["~> 1.9"])
    s.add_dependency(%q<mocha>.freeze, [">= 0"])
    s.add_dependency(%q<puma>.freeze, [">= 0"])
    s.add_dependency(%q<mysql2>.freeze, [">= 0"])
    s.add_dependency(%q<pg>.freeze, [">= 0"])
    s.add_dependency(%q<sqlite3>.freeze, [">= 0"])
    s.add_dependency(%q<rubocop-rails-omakase>.freeze, [">= 0"])
