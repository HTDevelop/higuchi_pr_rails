...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<sshkit>.freeze, [">= 1.23.0", "< 2.0"])
    s.add_dependency(%q<net-ssh>.freeze, ["~> 7.3"])
    s.add_dependency(%q<thor>.freeze, ["~> 1.3"])
    s.add_dependency(%q<dotenv>.freeze, ["~> 3.1"])
    s.add_dependency(%q<zeitwerk>.freeze, [">= 2.6.18", "< 3.0"])
    s.add_dependency(%q<ed25519>.freeze, ["~> 1.4"])
    s.add_dependency(%q<bcrypt_pbkdf>.freeze, ["~> 1.0"])
    s.add_dependency(%q<concurrent-ruby>.freeze, ["~> 1.2"])
