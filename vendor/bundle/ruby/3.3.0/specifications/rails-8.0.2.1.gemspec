...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<activesupport>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<actionpack>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<actionview>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<activemodel>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<activerecord>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<actionmailer>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<activejob>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<actioncable>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<activestorage>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<actionmailbox>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<actiontext>.freeze, ["= 8.0.2.1"])
    s.add_dependency(%q<railties>.freeze, ["= 8.0.2.1"])
